import { CCString, Component, Enum, RichText, _decorator } from 'cc';
import { CurrencyType, EVENT_RESET_LANGUAGE, Language, LanguageType, ReplaceModel } from './Language';
import { EDITOR } from 'cc/env';
const { ccclass, property, requireComponent } = _decorator;

type RenderHook = (label: LanguageRichText, textKey: string, ...replaceValue: string[]) => void;

@ccclass
@requireComponent(RichText)
export class LanguageRichText extends Component {
