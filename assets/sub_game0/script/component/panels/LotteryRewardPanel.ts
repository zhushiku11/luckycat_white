...
@ccclass('LotteryRewardPanel')
export class LotteryRewardPanel extends Component implements IPanel {
    ...
    onInit(rewardA: number) {
        ...
        switch (Language.currency) {
            case CurrencyType.US:
                this.bg.getComponentInChildren(SpriteSwitcher).index(0);
                break;
            case CurrencyType.BR:
                this.bg.getComponentInChildren(SpriteSwitcher).index(1);
                break;
        }
    ...
    onCloseBtnClick() {
        this.closeBtn.getComponent(Button).interactable = false;
        PanelFactory.close(LotteryRewardPanel);
        PanelFactory.close(LotteryPanel)
    }
}
